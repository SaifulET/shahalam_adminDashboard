  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      setStoredEmail(email);
       navigate("/admin/verify-code"); // Ensure email is stored even if there's an error, for retry purposes
    }
  };
...
export default AdminForgatePassword;
